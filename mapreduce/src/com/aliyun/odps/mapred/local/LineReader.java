...
public class LineReader {
	 ...
	 * @throws IOException
	 */
	public LineReader(InputStream in, LocalJobConf conf) throws IOException {
	 ...
	 * @throws IOException
	 */
	public LineReader(InputStream in, LocalJobConf conf, byte[] recordDelimiterBytes) throws IOException {
		this.in = in;
	...
	public int readLine(Text text, int maxLineLength, int maxBytesToConsume) throws IOException {
		if (this.recordDelimiterBytes != null) {
			return readCustomLine(text, maxLineLength, maxBytesToConsume);
		} else {
			return readDefaultLine(text, maxLineLength, maxBytesToConsume);
		}
	}
